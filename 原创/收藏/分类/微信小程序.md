...
3. [omi -- Omi === Preact + Scoped CSS +Store System +本机支持3kb javascript。](https://github.com/Tencent/omi)

	[文档](https://github.com/Tencent/omi/blob/master/README.CN.md)
4. [westore -- 世界上最小却强大的小程序框架 - 100多行代码搞定全局状态管理、跨页通讯和插件开发](https://github.com/dntzhang/westore)
